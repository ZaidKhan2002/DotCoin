...
const CryptoDetails = () => {
    ...
    // const cryptoDetails = data?.data?.coins?.find(coin => coin.coinId == coinId);
    const cryptoDetails = currency
    // const { data: coinHistory } = useGetCryptoHistoryQuery({ coinId, timePeriod });
    // const { data: coinHistory } = cryptoDetails?.history
    // data?.data?.coins?.forEach(element => {
    //     if(element.coinId == coinId){
    //         cryptoDetails = element??{}
    //     }
    // });
    ...
    return (
        <Col className="coin-detail-conatiner">
            <Col className="coin-heading-container">
                ...
                {cryptoDetails.symbol} ({cryptoDetails.slug}) Price
                </Title>
